...
python3 hansung-info/scripts/recommend_this_term.py --term 20261 --major Y030 --target 18 --year 2 --max-days 3 --format html --publish --publish-base-url https://daejja.yeoun.org
